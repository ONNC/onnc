...
public:
  ...
  virtual ComputeVisitor &createTargetInterpreter() const { return *new InterpreterBase(); }
  virtual InterpreterBase *hackInterpreterBase(ComputeVisitor *pCv) const { return static_cast<InterpreterBase *>(pCv); }
