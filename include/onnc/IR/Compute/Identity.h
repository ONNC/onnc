...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_IDENTITY_H
#define ONNC_IR_COMPUTE_OPERATOR_IDENTITY_H
...
class Identity : public ComputeOperator
{
public:
  enum IOConst {
    kInput = 0,
