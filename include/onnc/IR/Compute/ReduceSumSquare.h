...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_REDUCESUMSQUARE_H
#define ONNC_IR_COMPUTE_OPERATOR_REDUCESUMSQUARE_H
...
class ReduceSumSquare : public ComputeOperator
{
public:
  enum IOConst {
    kData = 0,
...
public:
  ...
  ReduceSumSquare(const IntsAttr& pAxes,
