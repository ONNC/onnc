...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_LOGSOFTMAX_H
#define ONNC_IR_COMPUTE_OPERATOR_LOGSOFTMAX_H
...
class LogSoftmax : public ComputeOperator
{
public:
  enum IOConst {
    kInput = 0,
...
public:
  ...
  // clang-format off
  LogSoftmax(const IntAttr& pAxis);

  // clang-format on

  // shallow copy constructor.
  LogSoftmax(const LogSoftmax &pCopy);
