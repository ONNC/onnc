...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_REDUCEMEAN_H
#define ONNC_IR_COMPUTE_OPERATOR_REDUCEMEAN_H
...
class ReduceMean : public ComputeOperator
{
public:
  enum IOConst {
    kData = 0,
...
public:
  ...
  // clang-format off
  ReduceMean(const IntsAttr& pAxes,
             const IntAttr& pKeepdims);

  // clang-format on

  // shallow copy constructor.
  ReduceMean(const ReduceMean &pCopy);
