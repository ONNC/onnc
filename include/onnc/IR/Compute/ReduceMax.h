...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_REDUCEMAX_H
#define ONNC_IR_COMPUTE_OPERATOR_REDUCEMAX_H
...
class ReduceMax : public ComputeOperator
{
public:
  enum IOConst {
    kData = 0,
...
public:
  ...
  ReduceMax(const IntsAttr& pAxes,
