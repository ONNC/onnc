...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_SOFTSIGN_H
#define ONNC_IR_COMPUTE_OPERATOR_SOFTSIGN_H
...
class Softsign : public ComputeOperator
{
public:
  enum IOConst {
    kInput = 0,
