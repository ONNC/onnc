...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_SOFTPLUS_H
#define ONNC_IR_COMPUTE_OPERATOR_SOFTPLUS_H
...
class Softplus : public ComputeOperator
{
public:
  enum IOConst {
    kX = 0,
