...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_FLATTEN_H
#define ONNC_IR_COMPUTE_OPERATOR_FLATTEN_H
...
class Flatten : public ComputeOperator
{
public:
  enum IOConst {
    kInput = 0,
...
public:
  ...
  // clang-format off
  Flatten(const IntAttr& pAxis);

  // clang-format on

  // shallow copy constructor.
  Flatten(const Flatten &pCopy);
