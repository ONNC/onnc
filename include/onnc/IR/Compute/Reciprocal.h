...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_RECIPROCAL_H
#define ONNC_IR_COMPUTE_OPERATOR_RECIPROCAL_H
...
class Reciprocal : public ComputeOperator
{
public:
  enum IOConst {
    kX = 0,
...
public:
  ...
  Reciprocal(const Reciprocal &pCopy);
