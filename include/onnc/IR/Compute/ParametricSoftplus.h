...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_PARAMETRICSOFTPLUS_H
#define ONNC_IR_COMPUTE_OPERATOR_PARAMETRICSOFTPLUS_H
...
class ParametricSoftplus : public ComputeOperator
{
public:
  enum IOConst {
    kX = 0,
...
public:
  ...
  // clang-format off
  ParametricSoftplus(const FloatAttr& pAlpha,
