...
//
//===----------------------------------------------------------------------===//
#ifndef ONNC_IR_COMPUTE_OPERATOR_REDUCESUM_H
#define ONNC_IR_COMPUTE_OPERATOR_REDUCESUM_H
...
class ReduceSum : public ComputeOperator
{
public:
  enum IOConst {
    kData = 0,
...
public:
  ...
  // clang-format off
  ReduceSum(const IntsAttr& pAxes,
            const IntAttr& pKeepdims);

  // clang-format on

  // shallow copy constructor.
  ReduceSum(const ReduceSum &pCopy);
