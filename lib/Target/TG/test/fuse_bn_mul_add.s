...
#; CHECK: FLOAT tensor <4, 64, 112, 112> %scale_conv1_1 = Scale <axis:INT 1, broadcast:INT 1> (FLOAT tensor <4, 64, 112, 112> %data_0, FLOAT tensor <64> %bn_conv1_scale_0, FLOAT tensor <64> %bn_conv1_bias_0)
