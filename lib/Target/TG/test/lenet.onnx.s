...
#; CHECK: <500 x INT8>({{.*}}) %ip1_1 = Gemm <inRowNum:1, inColNum:320, outColNum:1f4, m_WeightTp:1, lShiftWidth:0, rShiftWidth:a> (<800 x INT8>({{.*}}) %OC2_DUMMY_0, <400000 x INT8>({{.*}}) %ip1_w_0, <500 x INT16>({{.*}}) %ip1_b_0)
#; CHECK: <500 x INT8>({{.*}}) %relu1_1 = ReLU <negativeSlope:0, N:1, C:1, H:1f4, W:1> (<500 x INT8>({{.*}}) %relu1_1)
#; CHECK: <10 x INT8>({{.*}}) %ip2_1 = Gemm <inRowNum:1, inColNum:1f4, outColNum:a, m_WeightTp:1, lShiftWidth:0, rShiftWidth:a> (<500 x INT8>({{.*}}) %relu1_1, <5000 x INT8>({{.*}}) %ip2_w_0, <10 x INT16>({{.*}}) %ip2_b_0)
