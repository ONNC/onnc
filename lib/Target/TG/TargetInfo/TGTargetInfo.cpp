...
{
  onnc::TargetRegistry::RegisterTarget(getTheTGBM1880Target(), "TGBM1880",
                                       "BM1880Backend on TG", TG1880MatchFn);
  onnc::TargetRegistry::RegisterTarget(getTheTGBM1680Target(), "TGBM1680",
                                       "BM1680Backend on TG", TG1680MatchFn);
  onnc::TargetRegistry::RegisterTarget(getTheTGBM1682Target(), "TGBM1682",
                                       "BM1682Backend on TG", TG1682MatchFn);
}
