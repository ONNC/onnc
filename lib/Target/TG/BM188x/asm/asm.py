...
def get_tl():
    ...
    cur_inst = tl.add_inst("bmnet_tl_load_stride_bmkernel",
                           "tl_layer_load_stride").add_ctx()
    cur_inst.add_param("ga_src").set_type("u64")
    cur_inst.add_param("la_dst").set_type("laddr_t")
    cur_inst.add_param("Local_N").set_type("int")
    cur_inst.add_param("Local_C").set_type("int")
    cur_inst.add_param("Local_H").set_type("int")
    cur_inst.add_param("Local_W").set_type("int")
    cur_inst.add_param("Global_C").set_type("int")
    cur_inst.add_param("Global_H").set_type("int")
    cur_inst.add_param("Global_W").set_type("int")
    cur_inst.add_param("DoTranspose").set_type("bool")
    cur_inst.add_param("DoAligned").set_type("bool")
    cur_inst.add_param("isNeuron").set_type("bool")

    cur_inst = tl.add_inst("bmnet_tl_load_bmkernel",
                           "tl_layer_load").add_ctx()
    cur_inst.add_param("ga_src").set_type("u64")
    cur_inst.add_param("la_dst").set_type("laddr_t")
    cur_inst.add_param("Local_N").set_type("int")
    cur_inst.add_param("Local_C").set_type("int")
    ...
    cur_inst = tl.add_inst("bmnet_tl_store_stride_bmkernel",
                           "tl_layer_store_stride").add_ctx()
    cur_inst.add_param("ga_dst").set_type("u64")
    cur_inst.add_param("la_src").set_type("laddr_t")
    cur_inst.add_param("Local_N").set_type("int")
    cur_inst.add_param("Local_C").set_type("int")
    cur_inst.add_param("Local_H").set_type("int")
    cur_inst.add_param("Local_W").set_type("int")
    ...
    cur_inst = tl.add_inst("bmnet_tl_store_bmkernel",
                           "tl_layer_store").add_ctx()
    cur_inst.add_param("ga_dst").set_type("u64")
    cur_inst.add_param("la_src").set_type("laddr_t")
    cur_inst.add_param("Local_N").set_type("int")
    cur_inst.add_param("Local_C").set_type("int")
