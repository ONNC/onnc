...
int RandomNormalLikeLower::isMe(const xNode& pNode) const
{
  if (pNode.kind() == xSymbol("RandomNormalLike"))
    return kStdLower;
  return kNotMe;
}

ComputeOperator*
RandomNormalLikeLower::activate(ComputeGraph& pGraph, xNode& pNode) const
{
