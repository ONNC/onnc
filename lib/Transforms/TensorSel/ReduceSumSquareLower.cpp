...
int ReduceSumSquareLower::isMe(const ::onnx::Node& pNode) const
{
  if (pNode.kind() == ::onnx::Symbol("ReduceSumSquare"))
    return kStdLower;
  return kNotMe;
}

ComputeOperator*
ReduceSumSquareLower::activate(ComputeGraph& pGraph, ::onnx::Node& pNode) const
{
