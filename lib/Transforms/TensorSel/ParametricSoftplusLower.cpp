...
int ParametricSoftplusLower::isMe(const xNode& pNode) const
{
  if (pNode.kind() == xSymbol("ParametricSoftplus"))
    return kStdLower;
  return kNotMe;
}

ComputeOperator*
ParametricSoftplusLower::activate(ComputeGraph& pGraph, xNode& pNode) const
{
