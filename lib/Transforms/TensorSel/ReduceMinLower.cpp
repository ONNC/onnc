...
int ReduceMinLower::isMe(const ::onnx::Node& pNode) const
{
  if (pNode.kind() == ::onnx::Symbol("ReduceMin"))
    return kStdLower;
  return kNotMe;
}

ComputeOperator*
ReduceMinLower::activate(ComputeGraph& pGraph, ::onnx::Node& pNode) const
{
