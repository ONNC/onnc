...
static inline bool next_dim(int32_t ndim, int32_t* restrict dim, const int32_t* restrict dim_base,
...
static inline void add_initial_to_output(const float* restrict input, int32_t input_ndim,
                                         const int32_t* restrict input_dims, int32_t* restrict axis_dis, int32_t* pads,
                                         int32_t* restrict axis_pad_dis, float* restrict output)
{
...
static inline void pad_along_axis(float* restrict output, int32_t output_ndim, const int32_t* restrict output_dims,
                                  const int32_t* restrict pads, const int32_t* restrict axis_pad_dis,
                                  const int32_t axis, int32_t* restrict object_area, const int32_t mode)
{
  ...
  for (int32_t dim = 0; dim < iter_dim_num; dim++)
    iter_dim_max[dim] += 1;
...
static inline void padding(float* restrict output, int32_t output_ndim, const int32_t* restrict output_dims,
                           const int32_t* restrict pads, const int32_t* restrict axis_pad_dis,
                           int32_t* restrict object_area, const char* restrict mode, float value)
{
  ...
  case CONSTANT_MODE: {
    ...
    do {
      if (in_obj_area(iter_index, object_area, output_ndim))
        continue;
