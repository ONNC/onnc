...
static int32_t con(int32_t* meofarr, int32_t ndim, const int32_t* restrict dims)
{
  int32_t mul = 1, res = 0;
...
static void Enu(const float* restrict A, const int32_t* restrict A_dims, const float* restrict B,
